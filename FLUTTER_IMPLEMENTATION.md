...
| 14 | `uArmWobble` | 0.0 | static noise warp on the arm phase; windings wander, stars+smoke together |
...
| 39–41 | `uArmColor` | 0.0, 0.482, 1.0 | boom |
| 42–44 | `uOuterHazeColor` | 0.259, 0.345, 1.0 | boom |
| 45–47 | `uStarColor` | 1.0, 1.0, 1.0 | boom |
